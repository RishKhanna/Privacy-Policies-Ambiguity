...
# Navigation : Columns
    ...
    st.markdown("To view the data in terms of the categories that introduce ambiguity into the document, we present the this section, which displays the data visually about the distribution of quantities like condition, generalization etc. across the companies whose privacy policies were used in the corpus")
...
if rad == "Query Analysis":
    ...
    st.markdown("The averages per company for the query selected above is displayed")
